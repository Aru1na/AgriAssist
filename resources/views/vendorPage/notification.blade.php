...
<div class="flex flex-col items-center w-full md:w-[500px] bg-white shadow-lg rounded-lg p-6 ml-20 md:ml-32">
  <h2 class="text-xl font-bold mb-4 text-gray-700">Notifications</h2>
