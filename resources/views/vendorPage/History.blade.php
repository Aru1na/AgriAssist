...
<div class="flex flex-col items-center w-full md:w-[600px] bg-white shadow-lg rounded-lg p-6 ml-20 md:ml-32">
  ...
  <!-- Orders Table (No Vertical Borders) -->
  <div class="w-full overflow-x-auto">
    <table class="w-full border-collapse">
      <thead>
        <tr class="bg-green-600 text-white">
          <th class="px-4 py-3 text-left">Date</th>
          <th class="px-4 py-3 text-left">Resupply</th>
        </tr>
      </thead>
      <tbody>
        <tr class="border-b border-gray-300">
          <td class="px-4 py-3">2024-12-01</td>
          <td class="px-4 py-3">Don't leave me in all this pain</td>
        </tr>
        <tr class="border-b border-gray-300">
          <td class="px-4 py-3">2024-12-02</td>
          <td class="px-4 py-3">Don't leave me out in the rain</td>
        </tr>
        <tr class="border-b border-gray-300">
          <td class="px-4 py-3">2024-12-03</td>
          <td class="px-4 py-3">Come back and bring back my smile</td>
        </tr>
        <tr class="border-b border-gray-300">
          <td class="px-4 py-3">2024-12-04</td>
          <td class="px-4 py-3">Come and take these tears away</td>
        </tr>
      </tbody>
    </table>
  </div>
